...
class Generator:
    def __init__(self):
        ...
        self.A4 = [1,3,3,5,6,6,9,34,25,8] #лоялтность 43
        ...
        loyality= {'yang':[0,1,2,4,5,6,6,9,30,24,13]
                        ,'profi':[1,2,3,3,5,6,7,9,27,26,11],
                        'Sprofi':[1,2,3,4,5,5,6,9,29,26,10],
                           'old':[0,0,1,2,3,3,6,6,29,28,20]}
        #36
